...
public class AceEventMention extends AceMention{
	...
	public AceEventMention (AceEventMention copy)
	{
		this.id = copy.id;
		this.arguments = new ArrayList<AceEventMentionArgument>();
		this.arguments.addAll(copy.arguments);
		this.anchorExtent = copy.anchorExtent;
		this.anchorText = copy.anchorText;
		this.event = copy.event;
		this.headIndices = copy.headIndices;
