...
public class AceEntityMention extends AceMention {
	...
	/**
	 * Qi: for joint relation extraction
	 * @param id
	 * @param type
	 * @param head
	 */
	public AceEntityMention (String id, String type, Span head, AceEntity entity)
	{
		this.id = id;
		this.type = type;
		this.head = head;
	...
	/**
	 * Qi
	 *  returns 'true' if 'o' is an AceEntityMention with the same head span and 
	 *  entity type
	 */
	public boolean equals (Object o) {
		if(o instanceof AceEntityMention)
		{
			AceEntityMention mention = (AceEntityMention) o;
			return mention.head.equals(this.head) && mention.getType().equals(this.getType());
		}
 		return false;
	}
